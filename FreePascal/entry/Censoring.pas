...
(*
    Note: this seems far from perfect. For example, numbers cannot
    be entered and DEL key is not handled.
*)
...
Begin
    ...
    I:=0;
    EnterPw(PwV,I,X,Y);
    If UpStr(Pw)<>Upstr(PwV) Then 
        WriteLn('Verifying password failed...Aborting');
End.
