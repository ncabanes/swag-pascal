...
procedure ReadData
    ...
    begin (* procedure *)
     ...
     ReadLn ( MonthNumber ) ;
     Write ('Enter the days in the previous month: ');
     ReadLn ( PreviousMonthDays ) ;
     Write ('Enter the days in the current month: ');
     ReadLn ( CurrentMonthDays ) ;
     Write ('Enter the starting day: ');
     ReadLn ( StartingDay ) ;
    end  (* ReadData *) ;
