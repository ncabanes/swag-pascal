...
Type
   DateStrType = String[10];  {MM/DD/YYYY}


Procedure ConvDate(DateStr: DateStrType;
 ...
 {this converts the date from string to numbers for month, day, and year}
  ...
  Begin
    ...
    Val(Copy(DateStr, 7, 4), Year, ErrorCode);
    {Year := Year + CurrentYear}
  End;


Function Dow(DateStr: DateStrType): Byte;
