...
begin
    WriteLn('Hola to uppercase: ', StUpCase('Hola') );
    WriteLn('hOLa to lowercase: ', StLowCase('hOLa') );
    WriteLn('hOLa toggled: ', StToggleCase('hOLa') );
    WriteLn('And SmartCase: ', StSmartCase('this is smart cased') );
end.
