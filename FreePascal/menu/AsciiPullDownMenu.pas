(*
  ...
  Description: ASCII Pull down menu
...
begin
  ...
  ascihor(27,7,13, 32 ,7);asci_tekst(28,7,afspr[1],0,7);
  ...
  repeat
    ch :=readkey;
    if ch =#80 then begin
      ascihor(27,ay,13, 32 ,0);asci_tekst(28,ay,afspr[ay-6],6,0);
      inc(ay);if ay =13 then ay :=7;
      ascihor(27,ay,13, 32 ,7);asci_tekst(28,ay,afspr[ay-6],0,7);
    end;
    if ch =#72 then begin
      ascihor(27,ay,13, 32 ,0);asci_tekst(28,ay,afspr[ay-6],6,0);
